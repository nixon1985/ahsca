<?php
	...
	try {				
		...
		if(!empty($user_name) && !empty($user_pass)){			
            ...
            $stmt = $conn->prepare("SELECT * FROM appuser u LEFT JOIN emp_info m ON m.emp_no=u.user_id WHERE u.user_name=:user_id AND u.user_password=:user_password LIMIT 1");
			...
			if($stmt->rowCount() > 0 && $userInfo['is_active']==1){
                ...
                $_SESSION['member_name']    = $userInfo['emp_name'];
